  ...
  if (error) {
    return (
      <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-red-700">
        Failed to load daily pick: {error.message}
      </div>
    );
  }
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Today&apos;s top business opportunity based on trending searches
            </p>
          </div>
          <Link
        ...
        <EmptyState
          ...
          description="The daily trend pick job hasn't run yet today. Check back later or run it from the admin panel."
        />
      </div>
    );
  }
