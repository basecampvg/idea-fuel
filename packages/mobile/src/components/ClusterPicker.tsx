...
export function ClusterPicker({
  ...
  const { data: clusterList } = trpc.cluster.list.useQuery();
    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={onClose}>
        <TouchableOpacity activeOpacity={1} style={styles.content}>
          <Text style={styles.title}>Pin to Cluster</Text>
          ...
          {!showCreate ? (
            <>
              <FlatList
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    ...
                    <Text style={styles.itemCount}>{item.thoughtCount}</Text>
                  </TouchableOpacity>
                )}
                ListEmptyComponent={
              ...
              >
                ...
                <Text style={styles.createBtnText}>New Cluster</Text>
              </TouchableOpacity>
            </>
          ) : (
            <>
